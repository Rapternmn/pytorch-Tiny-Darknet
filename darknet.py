...
class Darknet(nn.Module):
    ...
    def forward(self, x, CUDA):
        ...
        for i in range(len(modules)):        
            ...
            if module_type == "convolutional" or module_type == "upsample" or module_type == "maxpool" or module_type == "avgpool":
    ...
    def load_weights(self, weightfile):
        ...
        # 3. Subversion number 
        # 4. IMages seen 
        header = np.fromfile(fp, dtype = np.int32, count = 4)  ### -> This is for Tiny Darknet. For Yolo, count = 5
